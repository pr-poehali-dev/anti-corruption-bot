      ...
      items: [
        {
          ...
          answer: 'Подарки стоимостью до 3000 рублей можно принимать без согласования. Любые подарки дороже должны быть зарегистрированы в системе и согласованы с комплаенс-отделом.'
        },
        {
      ...
      items: [
        {
          ...
          answer: 'Конфликт интересов возникает, когда личные интересы сотрудника влияют или могут повлиять на выполнение служебных обязанностей. Это может включать родственные связи, финансовую заинтересованность или иные личные отношения.'
        },
        {
